---
id: functional-architecture-overview
title: eSSIF-Lab Functional Architecture Overview
---

The primary purpose of the eSSIF-Lab Functional Architecture is to provide an overview and detailed specifications of the various functions/capabilities that are needed to allow %%parties|party%% to (electronically) conduct %%business transactions|business-transaction%% with one another. The functional architecture also shows how such capabilities work together to achieve this.
