const sidebars = {
  ...
  tev2SideBar: [
    ...
    { type: 'category',
      label: 'Methods',
      link: {type: 'doc', id: 'tev2/terminology-design'},
      items: [
        { type: 'autogenerated', dirName: 'tev2/methods' },
        { type: 'doc', label: 'Terminology - Mental Model', id: 'tev2/terms/patterns/pattern-terminology'},
      ]
    },
    { type: 'category',
      label: 'Roles',
