...
title: NewTerm (Scope:ExistingScope)
---
...
## Scope
<!--Short text (label, abbreviation) used to refer to the %%scope%% within which the %%term%% is defined. The default is essifLab.-->
essifLab

## Concept
<!--Specify the %%concept-file%% that serves as the definition of the %%concept%% to which `NewTerm` will refer-->
