...
glossaryText: "the combined %%knowledge^knowledge%% about that %%entity^entity%% of all %%parties^party%%, i.e. the union of all %%partial identities^partial-identity%% of which a specific %%entity^entity%% is the subject."
date: 20210803
---

### Short Description
The **Identity** (of an %%entity|entity%%) is the union of all %%partial identities|partial-identity%% of which that Entity is the subject.
