...
1. %%expectations|expectation%%, because such kinds of %%objectives|objective%% can only be %%governed|governance%% as %%managing|management%% them (i.e. the production of the assocated results) is out of their %%scope of control|scope-of-control%%.
