...
It is common for transactions to be governed by (the [legal system(s)](@) of) at least one [jurisdiction](@), because they can contain relevant rules of various kinds, e.g. in the areas of
