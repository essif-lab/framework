...
- someone (or an organization, collectively referred to as a '[party](@)') or something that is 'under [guardianship](guardianship-arrangement@)', i.e. being cared for, guarded, protected or defended - we call this the '[dependent](@)', and
...
Guardianship [governance](@) is the acts/processes of governing/overseeing the control and direction of whatever relates to guardianships. It oversees and directs the establishment of [guardianship types](guardianship-type@), defining the various stakeholder roles and associating their rights and duties towards one another.
