...
A Term MUST be a word or phrase that is linked to at least one <Term popup="<essifLabTerminology-scope hovertext>" reference="scope">context</Term> and refers to precisely one %%concept%%. 
...
## Related Concepts
<!--Link to any <Term popup="undefined" reference="concept">concepts</Term> that are similar but distinct, with a note about the relationship.-->
