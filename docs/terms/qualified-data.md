...
### Short Description
**Qualified data** is %data% that comes with assurances, at least regarding its provenance and integrity, and that can be combined electronically in semantically valid ways.
