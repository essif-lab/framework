...
## Purpose
The **Identity pattern** captures the concepts and relations that explain how digital identities work, how this relates to (attributes in) %%credentials|credential%%, and how they can be put to use in %%SSI contexts|self-sovereign-identity%%.
