...
glossaryText: "the capability to securely store data as requested by %%colleague agents|colleague-agents%%, and to provide stored data to %%colleague agents|colleague-agents%% or %%peer agents|peer-agent%%, all in compliance with the rules of its %%principal|principal%%'s %%wallet policy|wallet-policy%%."
---
